...
/**
 * ARCHIVED LEGACY MODULE. Production levels import furniture.js canonical
 * metadata layouts instead. Keep this file intact for historical tools/tests;
 * its numeric voxel writes are intentionally deprecated and must not be reused.
 */
