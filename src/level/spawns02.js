...
/**
 * 关卡 02「废弃诊所」的敌人出生点池（15 人，tier 分层与 01 同构）。
 *
 ...
 *   tier 1（简单 10 人）：9 个房间全有人，保证「找得到、打得过」。
 *   tier 2（困难 13 人）：接待追加武装巡逻、隔离西角与停尸补人。
 *   tier 3（专家 15 人）：庭院出现 DMR 武装巡逻（长视线威胁）+ 诊 B 伏击。
 *
 * ══ 巡逻路线同样要求「实测通畅」══
 *
...
export const ENEMY_SPAWNS02 = [
  ...
  // 武装巡逻：AR + 护甲。餐桌把中庭堵死，环路走南侧化验区。
  {
    x: 10.5, y: Y1, z: 41.5, yaw: Math.PI / 2,
    archetype: ARCHETYPE.PATROLLER, weapon: 'ar', tier: 1, armored: true,
    patrol: [[10.5, 41.5], [15.5, 41.5], [15.5, 45.5], [10.5, 45.5]],
  },
